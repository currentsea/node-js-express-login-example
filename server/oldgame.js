...
function Oldgame(lastGameId, lastHash, bankroll, gameHistory) {
    var self = this;
    ...
    function runGame() {
        ...
        db.createGame(self.gameId + 1, function (err, info) {
            ...
            self.maxWin = Math.round(self.bankroll * 0.05); // Risk 3% per game
    ...
    function endGame(forced) {
        ...
        function dbTimeout() {
            dbTimer = setTimeout(function() {
                console.log('Oldgame', gameId, 'is still ending... Time since crash:',
...
util.inherits(Oldgame, events.EventEmitter);

Oldgame.prototype.getInfo = function() {
...
Oldgame.prototype.placeBet = function(user, betAmount, autoCashOut, callback) {
    var self = this;
...
Oldgame.prototype.doCashOut = function(play, at, callback) {
...
Oldgame.prototype.runCashOuts = function(at) {
    var self = this;
...
Oldgame.prototype.setForcePoint = function() {
    var self = this;
...
Oldgame.prototype.cashOut = function(user, callback) {
    var self = this;
...
Oldgame.prototype.cashOutAll = function(at, callback) {
    var self = this;
...
Oldgame.prototype.shutDown = function() {
    var self = this;
